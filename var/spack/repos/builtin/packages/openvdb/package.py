...
#     depends_on("ilmbase@2.4", when="@10.1.0")
    depends_on("openexr@3.1:", when="@10.1.0")
    depends_on("intel-tbb@2020.3", when="@10.1.0")
    depends_on("zlib@1.2.7:", when="@10.1.0")
    depends_on("boost@1.80+iostreams+system", when="~python @10.1.0")
    depends_on("boost@1.80+iostreams+system+python+numpy", when="+python @10.1.0")
    ...
    depends_on("python@3.10", when="+python @10.1.0")
...
#     depends_on("imath@3.1:", when="@11.0.0")
    depends_on("openexr@3.2:", when="@11.0.0")
    depends_on("intel-tbb@2020.3", when="@11.0.0")
    depends_on("zlib@1.2.7:", when="@11.0.0")
    depends_on("boost@1.82+iostreams+system", when="~python @11.0.0")
    depends_on("boost@1.82+iostreams+system+python+numpy", when="+python @11.0.0")
    ...
    depends_on("python@3.11", when="+python @11.0.0")
...
#     depends_on("imath@3.1:", when="@12.0.0")
    depends_on("openexr@3.3:", when="@12.0.0")
    depends_on("intel-oneapi-tbb@2021:", when="@12.0.0")
    ...
    depends_on("python@3.11", when="+python @12.0.0")
